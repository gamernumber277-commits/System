...
<head>
    ...
    <title>Admin Login - Lake View</title>
    <style>
        :root {
            --bg-1: #0e1f36;
            --bg-2: #0a1729;
            ...
            --mint: #ff6b6b;
            --mint-2: #ff4757;
            --mint-glow: rgba(255, 107, 107, 0.35);
            --text-main: #e9f7ff;
            --text-sub: #b7d7e8;
        }
        ...
        * {
        ...
        .light-cone {
            ...
            background: linear-gradient(180deg, rgba(255, 138, 138, 0.75), rgba(255, 138, 138, 0.25) 58%, rgba(255, 138, 138, 0.08) 100%);
            opacity: 0;
            transition: opacity 0.24s ease, filter 0.24s ease;
            pointer-events: none;
            z-index: 1;
            filter: drop-shadow(0 16px 40px rgba(255, 82, 82, 0.6)) blur(0.2px);
        ...
        .login-card::before {
            ...
            background: linear-gradient(180deg, rgba(255, 107, 107, 0.72), rgba(255, 107, 107, 0.06));
            opacity: 0;
        ...
        .submit-btn {
            ...
            font-weight: 700;
            cursor: pointer;
            transition: transform 0.16s ease, filter 0.12s ease, background 0.16s ease, color 0.12s ease, box-shadow 0.16s ease, border-color 0.12s ease;
            font-size: 17px;
        }

        /* Make button react on hover, focus and touch (active) */
        .submit-btn:hover,
        .submit-btn:focus,
        ...
        .submit-btn:active {
            ...
            box-shadow: 0 0 20px rgba(255, 107, 107, 0.7), 0 6px 22px rgba(255, 82, 82, 0.25) inset;
        ...
        .submit-btn:active {
            ...
            box-shadow: 0 0 14px rgba(255, 107, 107, 0.6) inset;
        ...
        .room.lit .scene {
            box-shadow: inset 0 0 70px rgba(255, 94, 77, 0.35), inset 0 20px 80px rgba(255, 82, 82, 0.2);
        }

        .room.lit .lamp-head {
            box-shadow: 0 0 26px rgba(255, 107, 107, 1), 0 0 40px rgba(255, 82, 82, 0.8);
        ...
        .room.lit .login-card::before {
            opacity: 1;
            box-shadow: -6px 0 22px rgba(186, 247, 167, 0.42);
        }

        .room.lit .login-card::before {
            opacity: 1;
            box-shadow: -8px 0 35px rgba(255, 107, 107, 0.9);
        }
...
<body>
    <div class="room" id="room">
        <div class="scene">
            ...
            <form id="loginForm" class="login-card" action="admin_process.php" method="POST">
                <h2>Welcome Back</h2>
                <p class="subtext">Admin access only</p>
                ...
                <a href="#" onclick="animateTo('login.php')" class="back-link">Return to Public Login</a>
            </form>
        </div>
    </div>
