...
<head>
    ...
    <style>
        :root {
            ...
            --mint: #5dade2;
            --mint-2: #3498db;
            --mint-glow: rgba(93, 173, 226, 0.35);
            --text-main: #e9f7ff;
            --text-sub: #b7d7e8;
        }
        ...
        * {
        ...
        .lamp-head {
            ...
            background: linear-gradient(180deg, #5dade2 0%, #2e86de 100%);
        ...
        .light-cone {
            ...
            background: linear-gradient(180deg, rgba(93, 173, 226, 0.75), rgba(93, 173, 226, 0.25) 58%, rgba(93, 173, 226, 0.08) 100%);
            opacity: 0;
            transition: opacity 0.24s ease, filter 0.24s ease;
            pointer-events: none;
            z-index: 1;
            filter: drop-shadow(0 16px 40px rgba(46, 134, 222, 0.6)) blur(0.2px);
        ...
        .login-card {
            ...
            border: 1px solid rgba(93, 173, 226, 0.68);
            border-radius: 14px;
        ...
        .login-card::before {
            ...
            background: linear-gradient(180deg, rgba(93, 173, 226, 0.72), rgba(93, 173, 226, 0.06));
            opacity: 0;
        ...
        .submit-btn:hover {
            ...
            color: #f0f4ff;
            border-color: rgba(93, 173, 226, 0.95);
            box-shadow: 0 0 16px rgba(93, 173, 226, 0.45);
        ...
        .room.lit .scene {
            box-shadow: inset 0 0 70px rgba(46, 134, 222, 0.35), inset 0 20px 80px rgba(93, 173, 226, 0.2);
        }

        .room.lit .lamp-head {
            box-shadow: 0 0 26px rgba(93, 173, 226, 1), 0 0 40px rgba(46, 134, 222, 0.8);
        ...
        .room.lit .login-card::before {
            opacity: 1;
            box-shadow: -8px 0 35px rgba(93, 173, 226, 0.9);
        }
...
<body>
    <div class="room" id="room">
        <div class="scene">
            ...
            <form id="loginForm" class="login-card" action="register_process.php" method="POST">
                ...
                <a href="#" onclick="animateTo('login.php')" class="back-link">Already have an account? Login here</a>
            </form>
        </div>
    </div>
    ...
    <script>
        (function () {
            ...
            // Easter egg: Click Create Account text 3 times to go to admin login
            let createAccountClickCount = 0;
            const createAccountTitle = document.querySelector('.login-card h2');
            if (createAccountTitle) {
                createAccountTitle.style.cursor = 'pointer';
                createAccountTitle.addEventListener('click', function(e) {
                    createAccountClickCount++;
                    if (createAccountClickCount >= 3) {
